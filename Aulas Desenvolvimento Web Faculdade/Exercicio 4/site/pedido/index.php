			...
			<div align = "Center">
				<fieldset style="width: 25%">
					<div align = "left">
						...
						<h4>Consultoria </h4>    
						<h5><input type="radio" name="codconsultoria" value="1" /> <label>De Forma Remota</label> <br/></h5>
						<h5><input type="radio" name="codconsultoria" value="2" checked/> <label>Visita na Loja - taxa R$ 30,00</label></h5>
